...
import com.proyecto.proyecto.Security.Dto.LoginUsuario;
import com.proyecto.proyecto.Security.Dto.NuevoUsuario;
...
import com.proyecto.proyecto.Security.Service.RolService;
import com.proyecto.proyecto.Security.Service.UsuarioService;
...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = "http://localhost:4200, https://frontendanto.web.app/")
